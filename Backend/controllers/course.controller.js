...
// Fixed buyCourses function in course.controller.js
...
export const buyCourses = async(req, res) => {
    ...
    try {
        ...
        // Create Stripe payment intent (amount in cents for USD)
        const amount = Math.round(course.price * 100); // Convert to cents and ensure integer
        ...
        if (error.type === 'StripeCardError') {
            return res.status(400).json({errors: "Payment failed: " + error.message});
        }
